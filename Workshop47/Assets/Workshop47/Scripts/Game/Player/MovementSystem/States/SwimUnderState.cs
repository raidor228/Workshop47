...
{
    public class SwimUnderState : MovementBaseState
    {
        public SwimUnderState(MovementStateContext stateContext, PlayerMovementFsm fsm) : base(stateContext, fsm)
        {
        }
        ...
        public override void Enter()
        {
            ...
            if (Fsm.PreviousState is not SwimSurfaceState)
            {
        ...
        public override void LogicUpdate()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        Fsm.SetState<SwimSprintUnderState>();
                        return;
                    }
                }
            }
        ...
        protected override void HandleMovement()
        {
            ...
            stateContext.DesiredVelocity += 
                Vector3.up * (stateContext.PlayerSettings.SwimSettings.BuoyancyForce * Time.deltaTime);
